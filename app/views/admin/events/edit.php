...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		...
		async function loadRegioni() {
			...
			// Se c'è una regione iniziale, carica le province corrispondenti
			if (initialRegioneId) {
		...
		async function loadProvince(regioneId) {
			...
			// Se c'è una provincia iniziale E la provincia è stata effettivamente selezionata nella dropdown,
			// allora carica i comuni corrispondenti.
			// La condizione `provinciaSelect.value === initialProvinciaId` non è strettamente necessaria qui
			// perché `populateDropdown` dovrebbe già aver impostato il valore corretto se `initialProvinciaId` esiste nei dati.
			// Basta controllare se `initialProvinciaId` è presente.
